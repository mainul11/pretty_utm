 ...
 * fired on activation
 */
class pretty_utm_Activator extends pretty_utm
{
	public $db;
    ...
    {
		// set version
		if( !get_option('pretty_utm_version') )
		{
			add_option( 'pretty_utm_version', $this->get_version(), '', 'yes' );
		}

		// update steps
		if( get_option('pretty_utm_version') && get_option('pretty_utm_version') != $this->get_version() )
		{
			// 
		}
		
		// update version
		if( get_option('pretty_utm_version') != $this->get_version() )
		{
			update_option( 'pretty_utm_version', $this->get_version() );
		}
