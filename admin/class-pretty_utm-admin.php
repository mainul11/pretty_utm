...
class pretty_utm_Admin {
    ...
    {
		add_menu_page( 'Pretty UTM', 'Pretty UTM', 'edit_posts', $this->plugin_name . '-settings-page', array($this, 'render_settings_page'), 'dashicons-share' );
	}
    ...
    {
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'assets/css/pretty_utm-admin.css?v=' . rand(), array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts()
    {
        ...
        wp_enqueue_script( $this->plugin_name,          plugin_dir_url( __FILE__ ) . 'assets/js/pretty_utm-admin.js?v=' . rand(), array( 'jquery' ), $this->version, false );
	}
    ...
    public function check_reset()
    {
        ...
        {
            $reset = new pretty_utm_Reset( $this->plugin_name );
            ...
            $activation = new pretty_utm_Activator( $this->plugin_name );
            $activation->run();
            unset($activation);
        }
    }
