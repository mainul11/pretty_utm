<div class="pretty_utm_container pretty_utm_tab pretty_utm_tab-1 active">
    <h3>Create a tracking link</h3>
    <form method="POST" id="pretty_utm_campaign-form" class="pretty_utm_form">
        <table class="form-table">
            ...
            <tr class="pretty_utm_custom-params disabled">
                <th scope="row">
        ...
        <p class="pretty_utm_add_custom-params clickable"><span class="dashicons dashicons-plus"></span> Add additional parameters</p>
    ...
    <div class="pretty_utm_result">
        ...
        <table class="wp-list-table widefat fixed striped pages">
            ...
            if ( count($links) < 1 )
            {
                // Demo example link
                ?>
                <tr class="pretty_utm_non-highlight wow fadeInUp">
