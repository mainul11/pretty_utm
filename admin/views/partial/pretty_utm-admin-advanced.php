<div class="pretty_utm_container pretty_utm_tab pretty_utm_tab-3">

    <form method="POST" class="pretty_utm_form">
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    ...
                    <?php } ?>
                    <p class="description">How to get your <a class="pretty_utm_tab_link" href="#pretty_utm_tab-4">Google API key</a>?</p>
                </td>
            </tr>
        </table>
